...
| 方法 | 说明 | 适用业务场景 |
|------|------|------------|
| `add` | 初始化一个TrafficSimulation对象，支持十万级别的城市交通车辆仿真模拟 | 向场景批量添加对象 |
| `autoHighlight` | 根据相机高度自动高亮TrafficSimulation对象包含的所有车辆 |  |
| `delete` | 删除一个或多个TrafficSimulation对象 | 按 ID 移除指定对象 |
| `focus` | 自动定位到合适的观察距离 | 相机定位到目标，点击联动跳转 |
| `hide` | 隐藏TrafficSimulation对象包含的所有车辆 | 按业务条件隐藏对象 |
| `hideHeatMap` | 隐藏TrafficSimulation对象的热力图效果 |  |
| `hideTextLabel` | 隐藏TrafficSimulation对象包含的所有车辆文字标签 |  |
| `highlight` | 高亮TrafficSimulation对象包含的所有车辆 |  |
| `show` | 显示TrafficSimulation对象包含的所有车辆 | 按业务条件显示对象 |
| `showHeatMap` | 显示TrafficSimulation对象的热力图效果 |  |
| `showTextLabel` | 显示TrafficSimulation对象包含的所有车辆文字标签 |  |
| `unHighlight` | 取消高亮TrafficSimulation对象包含的所有车辆 |  |
| `update` | 更新一个时刻的TrafficSimulation对象 | 运行时动态更新对象属性/状态 |
