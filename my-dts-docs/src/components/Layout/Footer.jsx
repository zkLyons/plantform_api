      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-sm text-muted hover:text-accent transition-smooth">
                  GitHub
                </a>
              </li>
              <li>
        ...
        <div className="pt-6 border-t border-edge text-center">
          <p className="text-xs text-muted">
            © 2026 飞渡科技 DTS Cloud. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
