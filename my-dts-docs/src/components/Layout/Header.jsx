      ...
      <div className="flex items-center justify-between h-full px-4 lg:px-6 max-w-[1600px] mx-auto">
          ...
          {navLinks.map((link) => {
            ...
            return (
              <Link
                key={link.to}
                to={link.to}
                className={`px-3 py-1.5 rounded-md text-sm transition-smooth ${
                  isActive
                    ? 'text-accent bg-accent/8 font-medium'
                    : 'text-muted hover:text-[#2d2926] hover:bg-surface'
                }`}
              >
                {link.label}
              </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-md border border-edge text-muted text-sm hover:border-edge-hover hover:text-[#2d2926] transition-smooth bg-elevated">
            ...
            <span>搜索文档</span>
            <kbd className="ml-2 px-1.5 py-0.5 text-xs bg-surface rounded border border-edge text-muted">
              ⌘K
            </kbd>
          </button>
          ...
          <a
            ...
            className="p-2 rounded-md text-muted hover:text-[#2d2926] hover:bg-surface transition-smooth"
            title="GitHub"
          >
          ...
          <button
            ...
            className="p-2 rounded-md text-muted hover:text-[#2d2926] hover:bg-surface transition-smooth lg:hidden"
          >
