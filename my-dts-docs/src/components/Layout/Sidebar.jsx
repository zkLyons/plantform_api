  ...
  return (
    <div className="mb-2">
      <button
        ...
        className="flex items-center gap-2 w-full px-3 py-2 text-[11px] font-semibold uppercase tracking-wider text-muted hover:text-[#2d2926] transition-smooth"
      >
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed lg:sticky top-16 left-0 z-40 h-[calc(100vh-64px)] w-64 shrink-0 border-r border-edge bg-base overflow-y-auto transition-transform duration-300 ${
